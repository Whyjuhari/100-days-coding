...
public class AppGui extends JFrame {
    ...
    private void showMainPage() {
        ...
        JFrame halamanUtama = new JFrame("Halaman Utama");
        halamanUtama.setSize(450, 450);
        halamanUtama.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        halamanUtama.setLayout(null);
    
        halamanUtama.add(label);
